...
# Removed feature imports (S2V, VACE, motion control, animation) - not supported in trimmed version
...
class WanVideoPipeline(BasePipeline):
    ...
    def __init__(self, device="cuda", torch_dtype=torch.bfloat16):
        ...
        self.audio_processor = None  # Removed: Wav2Vec2Processor
        self.text_encoder: WanTextEncoder = None
        self.image_encoder: WanImageEncoder = None
        self.dit: WanModel = None
        self.dit2: WanModel = None
        self.vae: WanVideoVAE = None
        self.motion_controller = None  # Removed: WanMotionControllerModel
        self.vace = None  # Removed: VaceWanModel
        self.vace2 = None  # Removed: VaceWanModel
        self.vap = None  # Removed: MotWanModel
        self.animate_adapter = None  # Removed: WanAnimateAdapter
        self.audio_encoder = None  # Removed: WanS2VAudioEncoder
    ...
    def from_pretrained(
        ...
        # Audio processor removed - S2V not supported in trimmed version
...
def model_fn_wan_video(
    dit: WanModel,
    motion_controller = None,  # Removed: WanMotionControllerModel
    vace = None,  # Removed: VaceWanModel
    vap = None,  # Removed: MotWanModel
    animate_adapter = None,  # Removed: WanAnimateAdapter
    ...
    **kwargs,
    ...
    # wan2.2 s2v - Removed: S2V not supported in trimmed version
    if audio_embeds is not None:
        raise NotImplementedError("S2V (speech-to-video) is not supported in this trimmed version")
